...
export class PropertiesAndAttributes extends LitElement {
  ...
  render() {
    return html`
      ...
      -->
      <fancy-message .messagePrefix=${messagePrefix} .message=${this.message || this.location.params.message}>
      </fancy-message>
      ...
      -->
      <fancy-message messageprefix="The message is: " .message=${this.message || this.location.params.message}>
      </fancy-message>
    `;
  }
}